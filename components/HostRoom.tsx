  ...
  const handleFileSeek = (e: React.ChangeEvent<HTMLInputElement>) => {  
      ...
      if (fileStreamUrl && fileStreamUrl.startsWith('http')) {
          if (fileRawPath) {
              ...
              // CRITICAL FIX: Changing the URL with a unique timestamp forces React
              // to tear down the component (due to the `key` prop) and rebuild it.
              // This acts as a hard reset for the decoder.
