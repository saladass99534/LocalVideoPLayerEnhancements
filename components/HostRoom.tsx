        ...
        <div ref={containerRef} className="flex-1 relative bg-black flex items-center justify-center overflow-hidden group select-none"  
            ...
            {fileStreamUrl && (
              <video 
                ...
                ref={fileVideoRef} 
                src={fileStreamUrl} 
                className="absolute top-0 left-0 w-full h-full object-contain -z-50 opacity-100 pointer-events-none" 
